...
int main() {
	...
	// for (int i = 0; i < (input11_conf.h * input11_conf.w * input11_conf.c); i++)
	// 	std::cout<<std::fixed<<std::setprecision(1)<<input11[i]<<std::endl;
	// std::cout<<  <<std::endl;
	// std::cout<<output11[10 * 64 + 10]<<std::endl;
	...
	// for (int i = 0; i < (output11_conf.h * output11_conf.w * output11_conf.c); i++) {
	// 	cout<<output11[i]<<std::endl;
	// }
