...
int main()
{
	...
	//relu1
	Data_conf input12_conf = {270, 270, 64};
	Data_conf output12_conf = {270, 270, 64};

	//pool1
	Data_conf input13_conf = {270, 270, 64};
	Data_conf output13_conf = {90, 90, 64};
	Pool_conf pool1_conf = {3, 3};
	
	//Conv2
	struct Conv_conf conv2_conf = {3, 3};
	Data_conf input21_conf = {90, 90, 64};
	Data_conf output21_conf = {90, 90, 128};

	//relu2
	Data_conf input22_conf = {90, 90, 128};
	Data_conf output22_conf = {90, 90, 128};

	//pool2
	Data_conf input23_conf = {90, 90, 128};	
	Data_conf output23_conf = {30, 30, 128};
	...
	Data_conf input11_tiled_conf = {29, 29, 3};
	Data_conf output11_tiled_conf = {27, 27, 64};

	Data_conf input12_tiled_conf = {27, 27, 64};
	Data_conf output12_tiled_conf = {27, 27, 64};

	Data_conf input13_tiled_conf = {27, 27, 64};
	Data_conf output13_tiled_conf = {9, 9, 64};

	Data_conf input21_tiled_conf = {9, 9, 64};
	Data_conf output21_tiled_conf = {9, 9, 128};

	Data_conf input22_tiled_conf = {9, 9, 128};
	Data_conf output22_tiled_conf = {9, 9, 128};

	Data_conf input23_tiled_conf = {9, 9, 128};
	Data_conf output23_tiled_conf = {3, 3, 128};
